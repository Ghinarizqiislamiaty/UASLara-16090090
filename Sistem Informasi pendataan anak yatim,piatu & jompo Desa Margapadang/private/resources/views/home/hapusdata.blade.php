			...
			<div class="col-sm-10">
				<div class="card text-center">
					<div class="card-header indigo" style="color:#ffffff;">
						Hapus Data Yatim/Piatu
					</div>
					<div class="card-body">
						<form action="{{route('data.destroy',$datayatim)}}" method="post" >
							@csrf
									...
									<table class="table">
										<thead>
											<tr>
												<th  class="">Nama </th>
												<th> : </th>
												<td class=""> {{$datayatim->nama}}</td>
											</tr>
											</tr>
												<th  class="">Tanggal Lahir </th>
												<th> : </th>
												<td class=""> {{$datayatim->tanggalLahir}}</td>
											</tr>
											<tr>
												<th  class="">Alamat </th>
												<th>  :</th>
												<td class=""> {{$datayatim->alamat}}</td>
											</tr>
											<tr>
												<th  class="">Jenis Kelamin </th>
												<th> : </th>
												<td class=""> {{$datayatim->jenis_kelamin}}</td>
											</tr>
											<tr>
												<th  class=""> Status </th>
												<th> : </th>
												<td class="">{{$datayatim->status}} </td>
											</tr>
										</thead>
									</table>
									<hr>							
