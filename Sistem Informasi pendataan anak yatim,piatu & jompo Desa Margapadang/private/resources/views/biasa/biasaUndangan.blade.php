...
@section('main')
	...
	<div class="container-fluid">
		<form name="bulk_action_form" action="{{route('cetak.yatim')}}" method="post">
		@csrf
		<div class="row">
			<div class="col-sm-2">
				<div class="card">
			...
			<div class="col-sm-4">
				<div class="card">
					<div class="card-header indigo" style="color:#ffffff;">
						Masukan Tempat dan Waktu Santunan
					</div>
					<div class="card-body">
			...
			<div class="col-sm-6">
				<div class="card">
					<div class="card-header indigo" style="color:#ffffff;">
						Pilih Data Yang Akan Cetak Undangan
					</div>
					<div class="card-body">
						<table id="example" class="table table-bordered table-hover text-center display responsive nowrap databiasa" style="width:100%">
							...
							<tbody>
								<tr>
									<td><input type="checkbox" name="checked_id[]" class="checkbox" value="{{$datayatim->nama}}"/></td>        
									<td>{{$datayatim->nama}}</td>
								</tr> 
							</tbody>
							@endforeach
						</table>
